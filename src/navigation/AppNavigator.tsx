...
const sidebarStyles = StyleSheet.create({
  ...
  profileInitial:{ fontSize: 13, fontFamily: 'Syne_700Bold', color: '#fff' },
  ...
  upgradeTitle: { fontSize: 12, fontFamily: 'Syne_700Bold', color: colors.primary, marginBottom: 4 },
...
const topBarStyles = StyleSheet.create({
  ...
  title:     { fontSize: 16, fontFamily: 'Syne_700Bold', color: colors.text1 },
