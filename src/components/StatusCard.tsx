// StatusCard v4 — Dark navy hero + urgency bar chart
// Empty state: light card (matches freeBar height)
// Active state: dark navy with stacked urgency bars
...
interface StatusCardProps {
  ...
  totalDocs: number;
  deadlines?: DeadlineItem[]; // all deadlines for bar chart
}
      ...
      <View style={barStyles.track}>
        {bars.map((b, i) => (
          <View
            ...
            style={[
              barStyles.segment,
              { backgroundColor: b.color, flex: b.count / total },
    ...
    >
      ...
      <View style={styles.darkBody}>
        ...
        <View style={styles.darkRight}>
          <Text style={styles.darkDocCount}>
            {totalDocs} doc{totalDocs !== 1 ? 's' : ''} tracked
          </Text>
          {deadlines.length > 1 && (
            <Text style={styles.darkAllCount}>
...
const styles = StyleSheet.create({
  // Empty tile — same padding/structure as freeBar for visual consistency
