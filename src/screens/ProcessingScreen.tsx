...
const styles = StyleSheet.create({
  ...
  card:           { backgroundColor: colors.card, borderRadius: radius.lg, borderWidth: 1, borderColor: colors.border, overflow: 'hidden', ...shadows.sm },
  cardHeader:     { flexDirection: 'row', alignItems: 'center', gap: 12, padding: spacing.lg },
  cardIcon:       { width: 44, height: 44, borderRadius: 12, backgroundColor: colors.background, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: colors.borderLight },
