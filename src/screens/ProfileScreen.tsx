...
const styles = StyleSheet.create({
  ...
  avatarRing:   { width: 72, height: 72, borderRadius: 36, borderWidth: 1.5, borderColor: 'rgba(0,153,168,0.3)', backgroundColor: 'rgba(0,153,168,0.1)', alignItems: 'center', justifyContent: 'center', marginBottom: 12 },
  email:        { fontSize: 16, fontFamily: 'Inter_600SemiBold', color: '#fff', marginBottom: 8 },
  verifiedBadge:{ flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: 'rgba(0,153,168,0.12)', paddingHorizontal: 12, paddingVertical: 6, borderRadius: radius.full, borderWidth: 1, borderColor: 'rgba(0,153,168,0.2)' },
