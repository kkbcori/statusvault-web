...
const cardStyles = StyleSheet.create({
  card:     { backgroundColor: '#FFFFFF', borderRadius: 16, padding: 20, flex: 1, flexDirection: 'column' as any, ...(Platform.OS === 'web' ? { boxShadow: '0 2px 12px rgba(15,23,42,0.06), 0 0 0 1px rgba(15,23,42,0.04)' } : shadows.md) } as any,
...
const styles = StyleSheet.create({
  ...
  gridCard:            { flex: 1, display: 'flex' as any, flexDirection: 'column' as any } as any,
  cardFooterBtn:       { flexDirection: 'row', alignItems: 'center', gap: 5, marginTop: 'auto' as any, paddingTop: 12, borderTopWidth: 1, borderTopColor: '#F4F5FA' },
