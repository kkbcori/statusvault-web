                  ...
                  <View style={{ flex: 1 }}>
                    ...
                    <View style={styles.progressRow}>
                      <View style={styles.progressTrack}>
                        <View style={[styles.progressFill, { width: `${pct}%` as any, backgroundColor: pct === 100 ? '#28C76F' : '#7367F0' }]} />
                      </View>
              ...
              {CHECKLIST_TEMPLATES.map((t) => {
                ...
                return (
                  <TouchableOpacity
                    ...
                    onPress={() => !added && (addChecklist(t.id), setShowAdd(false))}
...
const styles = StyleSheet.create({
  ...
  card:          { backgroundColor: '#FFFFFF', borderRadius: 12, borderWidth: 1, borderColor: '#DBDADE', overflow: 'hidden' } as any,
  cardHeader:    { flexDirection: 'row', alignItems: 'center', gap: 12, padding: 16 },
  cardIcon:      { fontSize: 24 },
  cardTitle:     { fontSize: 14, fontFamily: 'Inter_600SemiBold', color: '#2F3349', marginBottom: 6 },
  progressRow:   { flexDirection: 'row', alignItems: 'center', gap: 8 },
  progressTrack: { flex: 1, height: 5, backgroundColor: '#F4F5FA', borderRadius: 3, overflow: 'hidden' },
  progressFill:  { height: '100%', borderRadius: 3 },
  progressText:  { fontSize: 11, fontFamily: 'Inter_500Medium', color: '#8588A5', width: 36 },
  ...
  checkbox:      { width: 18, height: 18, borderRadius: 4, borderWidth: 2, borderColor: '#DBDADE', alignItems: 'center', justifyContent: 'center', marginTop: 1, flexShrink: 0 },
  checkboxDone:  { backgroundColor: '#7367F0', borderColor: '#7367F0' },
  itemText:      { flex: 1, fontSize: 13, fontFamily: 'Inter_400Regular', color: '#2F3349', lineHeight: 20 },
